...
async def isSnivy(interaction: discord.Interaction):
    ...
    if guild.id == 1277801084097658882:
        ...
        await error_embed(
            title='This doesnt look like my server...',
            message='This bot is only available in the **Snivy guild**\n\nhttps://discord.gg/Bu2KwE2U',
        )
...
class isInGuild:
    ...
    async def isInGuild(self):
        ...
        for member in self.guild.members:
            ...
            minecraft_uuid = getData(
                'src/data/userData.json', user_id, 'minecraft_uuid'
            )
